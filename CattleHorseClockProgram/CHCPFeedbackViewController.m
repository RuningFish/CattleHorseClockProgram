...
- (void)viewDidLoad {
    ...
    chcp_feedback_title_label.text = @"请将您的意见或建议填入下方，以便我们更好的改进";
    ...
    [chcp_feedback_confirmButton setTitle:@"提交反馈" forState:UIControlStateNormal];
    ...
    chcp_feedback_confirmButton.backgroundColor = [UIColor colorWithRed:arc4random_uniform(256)/255.0 green:arc4random_uniform(256)/255.0 blue:arc4random_uniform(256)/255.0 alpha:1];;
